...
class ItemSuggesHomeView extends StatefulWidget {
  final DataTalk talkData;
  final DataUser userData;
  final int type;
  final String title;

  const ItemSuggesHomeView(
      {Key? key,
  ...
  State<StatefulWidget> createState() {
    return _ItemSuggesHomeViewState(talkData: talkData, type: type);
  }
}

class _ItemSuggesHomeViewState extends State<ItemSuggesHomeView> {
  DataTalk talkData;
  int type;
  bool isImages = true;
  ...
  _ItemSuggesHomeViewState(
      {Key? key, required this.talkData, required this.type});
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        ScaleTap(
                          onPressed: () {
                            var userData = DataCache().getUserData();
                            if (userData.uid == 0) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
