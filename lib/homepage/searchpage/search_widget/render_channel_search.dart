...
class RenderVideoSearch extends StatefulWidget {
  Category category;
  RenderVideoSearch({Key? key, required this.category});
  @override
  State<StatefulWidget> createState() {
    return _RenderVideoSearch(category: category);
  }
}

class _RenderVideoSearch extends State<RenderVideoSearch> {
  Category category;
  _RenderVideoSearch({Key? key, required this.category});
